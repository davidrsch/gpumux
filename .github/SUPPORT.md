# Getting help with gpumux

Thanks for using gpumux. Before filing an issue, there are a few places
...
Armed with your reprex, the next step is to figure out [where to ask](https://www.tidyverse.org/help/#where-to-ask). 
  ...
  * If it's a question: start with [community.posit.co](https://community.posit.co/), 
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/davidrsch/gpumux/issues) to make sure the 
